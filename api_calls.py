...
def post_pschat_message(incoming_msg):
    headers = {
        "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySW5mbyI6eyJpZCI6MjE0MDgsInJvbGVzIjpbImRlZmF1bHQiXSwicGF0aWQiOiI2YjFmN2M2Ni0yYjgxLTQxZGMtYWNmYi0wYjVjMWJhNDM1M2EifSwiaWF0IjoxNjkwMjk0NDI3LCJleHAiOjE2OTgwNzA0Mjd9.Q7OQcnBJHEZ7EoSCMrmqAue6qJ0gD5t8JVImTB7rd3k",
        "Content-Type": "application/json",
    }
    url = "https://api.psnext.info/api/chat"
    data = {"message": incoming_msg, "options": {"model": "gpt35turbo"}}
    ...
    for place in local_results:
        if "rating" in place:
            if place["rating"] > 4.2:
                ...
                title = place["title"]
                places.append(title)
                # getting + setting street address
                if "address" in place:
                    if " · " in place["address"]:
