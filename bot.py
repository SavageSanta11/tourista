...
def bot():
    ...
    try:
        ...
        elif similarity_score('here', trans_msg) > 0.7 and location_populated and user_interest_populated:
        ...
        elif similarity_score("next", trans_msg)>0.7 and location_populated and user_interest_populated:
