...
def bot():
    ...
    try:
        ...
        #   user location from WhatsApp is stored   
            ...
            make_request(user_phone_number, "POST", api_request_headers, {'language': user_lang})
            ...
            user_update_location = make_request(user_phone_number, "PATCH", api_request_headers, {"location": user_loc})
